...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full min-h-screen flex items-center justify-center overflow-hidden ${className}`}>
      ...
      {/* Content Overlay */}
      <div className="relative z-10 container mx-auto px-4 md:px-8 flex flex-col items-center justify-center min-h-screen text-center">
        {/* Trust Badge */}
        {trustBadge && (
          <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            ...
            <span className="text-sm font-medium text-white">{trustBadge.text}</span>
          </div>
        )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {buttons.primary && (
              <button
                ...
                className="px-8 py-4 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105"
              >
            ...
            {buttons.secondary && (
              <button
                ...
                className="px-8 py-4 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 text-white font-semibold hover:bg-white/20 transition-all duration-300"
              >
...
// Default Shader Source - Scientific Gradient with Interactive Elements
...
// Perlin-like noise
float noise(vec2 p){
  vec2 i=floor(p),u=fract(p)*fract(p)*(3.-2.*fract(p));
  float
  a=rnd(i),
  b=rnd(i+vec2(1,0)),
  c=rnd(i+vec2(0,1)),
